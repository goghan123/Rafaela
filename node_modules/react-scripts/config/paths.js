...
if (
  ...
  module.exports = {
    ...
    appPublic: resolveOwn(`${templatePath}/client/public`),
    appHtml: resolveOwn(`${templatePath}/client/public/index.html`),
    appIndexJs: resolveModule(resolveOwn, `${templatePath}/client/src/index`),
    appPackageJson: resolveOwn('package.json'),
    appSrc: resolveOwn(`${templatePath}/client/src`),
    appTsConfig: resolveOwn(`${templatePath}/tsconfig.json`),
    appJsConfig: resolveOwn(`${templatePath}/jsconfig.json`),
    yarnLockFile: resolveOwn(`${templatePath}/yarn.lock`),
    testsSetup: resolveModule(resolveOwn, `${templatePath}/client/src/setupTests`),
